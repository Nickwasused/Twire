...
public class GetLiveStreamURL extends AsyncTask<String, Void, LinkedHashMap<String, Quality>> {
    ...
    protected String formatQuery(boolean isLive, String channelOrVod, String player) {
        return "{\n" +
    ...
    protected LinkedHashMap<String, Quality> doInBackground(String... params) {
        ...
        Request request = new Request.Builder()
                ...
                .post(RequestBody.create(MediaType.get("application/json"), formatQuery(true, streamerName, player)))
                .build();
